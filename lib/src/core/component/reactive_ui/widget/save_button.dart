...
class _RSaveButtonState extends State<RSaveButton> {
  ...
  void initState() {
    ...
    buttonStatusNotifier =
        widget.buttonStatusNotifier ?? ProcessStatusNotifier();
    super.initState();
  }
      ...
      builder: (context, constraints) {
        return AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color:
                (buttonStatusNotifier.status is DisabledStatus ||
                    buttonStatusNotifier.status is LoadingStatus)
  ...
  Widget _buttonText() {
    return LayoutBuilder(
      builder: (context, constraints) {
        debugger.dekhao(
          "Button status: ${buttonStatusNotifier.status.runtimeType}",
        );
