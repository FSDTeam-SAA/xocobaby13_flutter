...
import 'package:xocobaby13/core/api_handler/failure.dart';
import 'package:xocobaby13/core/api_handler/success.dart';
  ...
  Future<Either<DataCRUDFailure, Success<String>>> register({
    ...
    return asyncTryCatch(
      tryFunc: () async {
        ...
        return Success(message: message, data: 'Successful Register.');
      },
    );
  }
